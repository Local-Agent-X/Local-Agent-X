...
- **Files**:
  ...
  - Soak: 24h on Alex's machine with the flag flipped, watching p50/p95 latency on the warm path (target: parity with current ~0.9–3s on 3060 — per the existing memory, this is the gate).
