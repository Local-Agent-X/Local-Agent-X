...
**Totals:** 60 top-level dirs · 60 live · 0 with no live importer · 1080 non-test source files · 0 god files (>400 LOC).
...
| `src/tools/` | 37 | 124 | XL |  |
| `src/providers/` | 34 | 15 | L |  |
| `src/canonical-loop/` | 29 | 104 | XL |  |
