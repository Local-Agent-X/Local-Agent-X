...
**Totals:** 65 top-level dirs · 65 live · 0 with no live importer · 1587 non-test source files · 0 god files (>400 LOC).
...
| `src/tools/` | 71 | 192 | XL |  |
| `src/canonical-loop/` | 62 | 238 | XL |  |
| `src/providers/` | 62 | 20 | XL |  |
