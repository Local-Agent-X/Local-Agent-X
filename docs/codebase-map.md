...
**Totals:** 59 top-level dirs · 59 live · 0 with no live importer · 1111 non-test source files · 0 god files (>400 LOC).
...
| `src/canonical-loop/` | 29 | 116 | XL |  |
| `src/agent-store/` | 25 | 7 | M |  |
| `src/agency/` | 23 | 14 | L |  |
| `src/classifiers/` | 23 | 11 | L |  |
| `src/auth/` | 22 | 10 | L |  |
