...
**Totals:** 61 top-level dirs · 61 live · 0 with no live importer · 1292 non-test source files · 0 god files (>400 LOC).
...
| `src/ops/` | 69 | 22 | XL |  |
| `src/tools/` | 57 | 146 | XL |  |
| `src/canonical-loop/` | 44 | 146 | XL |  |
| `src/providers/` | 44 | 20 | L |  |
