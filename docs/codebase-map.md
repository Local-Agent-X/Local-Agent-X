...
**Totals:** 59 top-level dirs · 59 live · 0 with no live importer · 1220 non-test source files · 0 god files (>400 LOC).
...
| `src/canonical-loop/` | 39 | 140 | XL |  |
| `src/memory/` | 38 | 113 | XL |  |
| `src/classifiers/` | 33 | 15 | L |  |
