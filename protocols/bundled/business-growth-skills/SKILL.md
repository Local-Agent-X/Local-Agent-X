...
description: "4 business growth agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, upstream. Customer success (health scoring, churn), sales engineer (RFP), revenue operations (pipeline, GTM), contract & proposal writer. Python tools (stdlib-only)."
version: 1.1.0
...
bundle_meta:
  ...
  source_license: MIT
  imported_at: 2026-04-26T17:06:51.402Z
