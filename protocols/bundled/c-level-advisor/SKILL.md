...
description: "10 C-level advisory agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, upstream. CEO, CTO, COO, CPO, CMO, CFO, CRO, CISO, CHRO, Executive Mentor. Multi-role board meetings, strategy routing, structured recommendations. For founders needing executive-level decision support."
license: MIT
metadata:
  version: 2.0.0
...
bundle_meta:
  ...
  source_commit: f567c61def3fb86046d7242b4bf27fceb63ad8b4
  source_license: MIT
  imported_at: 2026-04-26T17:06:51.404Z
  attribution: "alirezarezvani/claude-skills (MIT). Source: https://github.com/alirezarezvani/claude-skills"
---
