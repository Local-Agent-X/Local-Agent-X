...
description: "23 engineering agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, upstream, and 6 more tools. Architecture, frontend, backend, QA, DevOps, security, AI/ML, data engineering, Playwright, Stripe, AWS, MS365. 30+ Python tools (stdlib-only)."
version: 1.1.0
...
bundle_meta:
  ...
  source_license: MIT
  imported_at: 2026-04-26T17:06:51.410Z
