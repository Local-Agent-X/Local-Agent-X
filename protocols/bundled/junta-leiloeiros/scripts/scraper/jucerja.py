...
Metodo: httpx com paginacao RileyAX
...
class JucerjaScraper(AbstractJuntaScraper):
    ...
    # Endpoint RileyAX real da paginacao (descoberto em 2026-02-25)
    ...
    async def parse_leiloeiros(self) -> List[Leiloeiro]:
        """
        Coleta todos os leiloeiros via endpoint RileyAX de paginacao.
