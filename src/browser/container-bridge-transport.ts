...
export const CONTAINER_BROWSER_ACTING_SESSION = "LAX_CONTAINER_BROWSER_ACTING_SESSION";
export const CONTAINER_BROWSER_OWNER_SESSION = "LAX_CONTAINER_BROWSER_OWNER_SESSION";
