 ...
 *
 * A session's tab lives in its own context (separate cookie jar — the
 * isolated default) or in the shared default context (cookies/logins shared
 * across sessions for continuity) when browserPerSessionContext is off.
 */
