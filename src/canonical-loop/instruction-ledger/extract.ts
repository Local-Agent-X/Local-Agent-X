 ...
 * edit any files").
 */
function vetoWriteBanOnEditDirective(prohibitions: readonly CapabilityClass[], userMessage: string): CapabilityClass[] {
...
export async function extractConstraints(
  ...
  const prohibitions = vetoWriteBanOnEditDirective(result.prohibitions, userMessage);
