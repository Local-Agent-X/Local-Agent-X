...
Examples (retain WITHOUT being asked):
  "I have a dog named Gigi" → memory_save(target="retain", content="W @Peter: has a dog named Gigi")
  ...
  "I hate when it spawns sub-agents" → memory_save(target="retain", content="S @Peter: dislikes sub-agent delegation, prefers direct tool use")
  "ScanProgress launched at NutriShop" → memory_save(target="retain", content="W @ScanProgress: launched at NutriShop McKinney, live with InBody data")
