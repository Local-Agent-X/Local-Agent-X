...
import {
  ...
  LEVEL_LABELS,
  levelName,
} from "./growth-tracker-store.js";
import type { SkillLevel, GrowthEntry } from "./growth-tracker-store.js";

export type { SkillLevel, GrowthEntry } from "./growth-tracker-store.js";
