...
/** The stored transcript projected for the chat UI — lives in
 *  session-ui-projection.ts; re-exported here because every caller already
 *  imports it from this module. */
export { projectSessionForUI } from "./session-ui-projection.js";
import { projectSessionForUI } from "./session-ui-projection.js";
