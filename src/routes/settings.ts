...
export const handleSettingsRoutes: RouteHandler = async (method, url, req, res, ctx, _role) => {
  ...
  if (method === "GET" && url.pathname === "/api/providers") {
    ...
    if (hasAnthropicOAuth) providers.push({ id: "anthropic", name: "Anthropic", models: ["claude-sonnet-4-6", "claude-opus-4-6", "claude-haiku-4-5-20251001"], active: currentProvider === "anthropic" });
