 ...
 *
 * Five integrated systems that exceed OpenClaw's per-call evaluation:
 *
...
// Tool call hashing for loop detection (inspired by OpenClaw)
...
export class ToolChainAnalyzer {
  ...
  /** Detect tool call loops (OpenClaw-style: generic repeat + ping-pong) */
