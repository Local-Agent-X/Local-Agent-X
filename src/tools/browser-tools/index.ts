 ...
 *   layout.ts        — emulate (device/viewport/UA), layout_report
...
import { handleEmulate, handleLayoutReport } from "./layout.js";
      ...
      return withBrowserLock(sessionId, async () => {
        ...
        try {
          ...
          switch (action) {
            ...
            case "layout_report": return await handleLayoutReport(manager);
