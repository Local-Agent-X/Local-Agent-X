...
export async function handleNavigate(
  ...
  // SSRF/scheme checks live in the context-level request guard (see
  // installRequestGuard in browser/guards.ts, installed via getPage). It
  // covers the initial URL AND every redirect/JS/click hop, fail-closed on
  // navigation requests; a blocked goto throws ERR_BLOCKED_BY_CLIENT which
  // the dispatcher converts to a clean tool error.
