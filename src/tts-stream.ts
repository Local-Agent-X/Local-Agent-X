...
const KOKORO_MODEL = join(homedir(), ".openclaw", "workspace", "voice-chat", "kokoro", "kokoro-v1.0.onnx");
const KOKORO_VOICES = join(homedir(), ".openclaw", "workspace", "voice-chat", "kokoro", "voices-v1.0.bin");
