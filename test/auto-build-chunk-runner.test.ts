 ...
 * exercised indirectly via test/auto-build-loop.test.ts which mocks the
...
import { _clearChunkAgentDefCache } from "../src/auto-build/agents/chunk-runner.js";
...
describe("chunk-runner definitions", () => {
  ...
  it("can be imported without side effects (lazy by design)", async () => {
    const mod = await import("../src/auto-build/agents/chunk-runner.js");
