...
describe("credential-patterns — inline value redaction", () => {
  ...
  const fixtures: Array<[string, string]> = [
    ...
    ["GitHub User-to-Server", `ghu_abcdefghij1234567890ABCDEFGHIJ123456`],
    ["GitHub refresh", `ghr_abcdefghij1234567890ABCDEFGHIJ123456`],
    ...
    ["Basic header", `Authorization: Basic ${TAIL}${TAIL}==`],
